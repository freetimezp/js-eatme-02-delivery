...
const RowContainer = ({ data }) => {
  ...
  return (
    <Swiper
      breakpoints={{ 420: { slidesPerView: 1, width: 300 }, 800: { slidesPerView: 2, width: 680 } }}
      navigation={{ nextEl: nextRef.current, prevEl: prevRef.current }}
      loop={true} slidesPerView={4} width={1320} grabCursor={true} spaceBetween={10}
    ...
    >
        ...
        {data && data?.map((item) => (
          ...
          >
            <div className="flex items-center justify-between">
              <img src={item?.imageURL} alt="fruit"
                className="w-40 max-w-40 h-40 max-h-40 -mt-10 rounded-md hover:rounded-none hover:scale-[1.1]" 
              />
      ...
      <div className="hidden md:flex w-full absolute bottom-0 gap-3 items-center justify-center">
